...
EntityMonster = ig.Box2DEntity.extend({
	...
	init: function( x, y, settings ) {
		...
		this.leftUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 260 , { id: 9 } );
		this.leftLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 360 , { id: 10 } );
		//right left - PLAYERS RIGHT
		this.rightUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 260 , { id: 11 } );
		this.rightLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 360 , { id: 12 } );
