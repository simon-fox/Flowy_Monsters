...
EntityMonster = ig.Box2DEntity.extend({
	...
	init: function( x, y, settings ) {
		...
		this.upperChest = ig.game.spawnEntity( EntityMonsterChest , 100 , 0 );
		this.torso = ig.game.spawnEntity( EntityMonsterChest , 100 , 0 );
		this.hips = ig.game.spawnEntity( EntityMonsterHips , 100 , 0 );
		this.leftUpperArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.leftLowerArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.rightUpperArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.rightLowerArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.leftUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.leftLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.rightUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
		this.rightLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 100 , 0 );
