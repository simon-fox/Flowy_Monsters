...
EntityMonster = ig.Box2DEntity.extend({
	...
	init: function( x, y, settings ) {
		//create parts
		//trunk
		this.upperChest = ig.game.spawnEntity( EntityMonsterChest , 100 , 50 , { id: 2 } );
		this.torso = ig.game.spawnEntity( EntityMonsterChest , 100 , 130 , { id: 3 } );
		this.hips = ig.game.spawnEntity( EntityMonsterHips , 100 , 210 , { id: 4 } );
		//left arm - PLAYERS LEFT
		this.leftUpperArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 50 , { id: 5 });
		this.leftLowerArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 150 , { name:"LOWERARM" , id: 6 } );
		//right arm - PLAYERS RIGHT
		this.rightUpperArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 50 , { id: 7 } );
		this.rightLowerArm = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 150 , { name:"LOWERARM" , id: 8 } );
		//left leg - PLAYERS LEFT
		this.leftUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 260 , { name:"UPPERLEG" , id: 9 } );
		this.leftLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 80 , 360 , { name:"LOWERLEG" , id: 10 } );
		//right left - PLAYERS RIGHT
		this.rightUpperLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 260 , { name:"UPPERLEG" , id: 11 } );
		this.rightLowerLeg = ig.game.spawnEntity( EntityMonsterLimbSegment , 190 , 360 , { name:"LOWERLEG" , id: 12 } );
